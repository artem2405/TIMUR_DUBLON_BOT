    ...
    private static async void VARIANT_OF_PURCHASE(Message message) // ВАРИАНТЫ ВОЗМОЖНОГО ЗАКАЗА ДЛЯ КАЖДОГО ИЗ РЕГИОНОВ
    {
        switch (message.Text)
        {
            ...
            case "Xbox":
                ...
                {
                    new KeyboardButton[] { "1250 ДУБЛОНОВ - 420 ₽", "2750 ДУБЛОНОВ - 880 ₽"},
                    new KeyboardButton[] { "5625 ДУБЛОНОВ - 1760 ₽", "11500 ДУБЛОНОВ - 3500 ₽" },
                    new KeyboardButton[] { "20500 ДУБЛОНОВ - 6040 ₽", "30000 ДУБЛОНОВ - 8440 ₽" },
                    new KeyboardButton[] { "47000 ДУБЛОНОВ - 12640 ₽" },
