...
partial class Bot
{
    private static bool STUPID_CHECK(Message message) // ЗАЩИТА НА СЛУЧАЙ ВВОДА НЕ ПРАВИЛЬНОЙ ИНФОРМАЦИИ ПРИ ВЫБОРЕ РЕГИОНА И ВИДА ПОКУПКИ
    {
        ...
        string[] basic = new string[] { "🔄 ПЕРЕЗАПУСТИТЬ БОТА 🔄", "↩️ ВЕРНУТЬСЯ НА ПРЕДЫДУЩИЙ ШАГ ↩️", "1250 ДУБЛОНОВ - 490 ₽",
        "2750 ДУБЛОНОВ - 990 ₽", "5625 ДУБЛОНОВ - 1810 ₽", "11500 ДУБЛОНОВ - 3580 ₽", "20500 ДУБЛОНОВ - 6330 ₽",
        "30000 ДУБЛОНОВ - 8300 ₽", "47000 ДУБЛОНОВ - 11550 ₽", "20500 ДУБЛОНОВ - 1500 ₽",
        "PlayStation", "PlayStation Турция", "Xbox", "iOS/Android"};
